...
public class View_GirisOgretmen extends javax.swing.JFrame {
    Controller_Ogretmen controller = new Controller_Ogretmen();

    public View_GirisOgretmen() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ÖĞRETMEN GİRİŞ");
    ...
    public void Giris() {
        ...
        Model_Main model = new Model_Ogretmen(txtTcNo.getText(), txtParola.getText());
        if (controller.Kontrol(model)) {
            int Id = controller.Getir(new Model_Ogretmen(txtTcNo.getText(), txtParola.getText())).getId();
            new View_PanelOgretmen(Id).setVisible(true);
            this.dispose();
            return;
        }
