...
public final class View_ParolaYonetici extends javax.swing.JFrame {
    ...
    public View_ParolaYonetici() {
        initComponents();
        setLocationRelativeTo(null);
        lbBaslik.setText(baslik);
    }

    public View_ParolaYonetici(int _Id) {
        initComponents();
        this.Id = _Id;
    ...
    public void Getir() {
        Model_Yonetici model = controller.Getir(new Model_Yonetici(Id));
