...
import Controller.Controller_Yonetici;
import Model.Model_Yonetici;


import javax.swing.JOptionPane;

public class View_GirisYonetici extends javax.swing.JFrame {
    Controller_Yonetici controller = new Controller_Yonetici();

    public View_GirisYonetici() {
        initComponents();
    ...
    public void Giris() {
        ...
        if (controller.Kontrol(txtKullaniciAd.getText(),txtParola.getText())) {
            int Id = controller.Getir(txtKullaniciAd.getText(), txtParola.getText()).getId();
            new View_PanelYonetici(Id).setVisible(true);
            this.dispose();
            return;
        }
